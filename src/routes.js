...
router.post('/cadastro_responsavel/cadastrar', cadastro_responsavel.cadastrar)
router.put('/cadastro_responsavel/editar', cadastro_responsavel.editar)
router.delete('/cadastro_responsavel/deletar', cadastro_responsavel.deletar)
router.get('/cadastro_responsavel/showall', cadastro_responsavel.showall)
